	...
	class PerspectiveCamera : public BaseCamera
	{
	  public:
		...
		inline Ray generateRay( const float p_sx, const float p_sy ) const override
		{
			...
			Vec3f focalPoint  = _viewportTopLeftCorner + _viewportU * p_sx - _viewportV * p_sy;
			Vec3f rayPosition = _position;
			return Ray( rayPosition, glm::normalize( focalPoint - rayPosition ) );
